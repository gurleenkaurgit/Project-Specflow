...
namespace MarsFramework.Pages
{
    internal class ShareSkillPage
    {
        ...
        internal void ValidateShareSkillData()
        {
            ...
            //Validate Start Date
            GlobalDefinitions.ValidateFieldData(Convert.ToDateTime(GlobalDefinitions.ExcelLib.ReadData(2, "Startdate")).ToString("yyyy-dd-MM"), StartDateDropDown.GetAttribute("value"), "Start Date");

            //Validate End Date
            GlobalDefinitions.ValidateFieldData(Convert.ToDateTime(GlobalDefinitions.ExcelLib.ReadData(2, "Enddate")).ToString("yyyy-dd-MM"), EndDateDropDown.GetAttribute("value"), "End Date");
